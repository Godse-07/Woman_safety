      ...
      if (user != null) {
        ...
        if (doc.exists) {
          ...
          setState(() {
            ...
            email = data['gemail'] as String?;
            number = data['number'] as String?;
            accountType = data['type'] as String?;
            childName = data['cname'] as String?;
            childEmail = data['mail'] as String?;
          });
        }
      }
    } catch (e) {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListTile(
                          ...
                          trailing: IconButton(
                            icon: Icon(Icons.edit),
                            onPressed: () =>
                                _editProfileField('cname', childName),
                          ),
                        ),
                      ),
                      SizedBox(height: 20),
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(10)),
                        child: ListTile(
                          title: Text('Child Email: $childEmail'),
                          trailing: IconButton(
                            icon: Icon(Icons.edit),
                            onPressed: () =>
                                _editProfileField('cmail', childEmail),
                          ),
                        ),
                      ),
                    ],
